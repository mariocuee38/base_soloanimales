...
$sql_empleados = "SELECT Empleados.ID, Empleados.Nombre, Empleados.Tipo, Habitat.Nombre AS NombreHabitat FROM Empleados LEFT JOIN Cuidador ON Empleados.ID = Cuidador.EmpleadoID LEFT JOIN Limpiador ON Emplea>
